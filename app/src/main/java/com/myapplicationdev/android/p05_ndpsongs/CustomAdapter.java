...
public class CustomAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvTitle = (TextView) rowView.findViewById(R.id.textViewShowTitle);
        tvSinger = (TextView) rowView.findViewById(R.id.textViewShowSingers);
        tvYear = (TextView) rowView.findViewById(R.id.textViewShowYear);
